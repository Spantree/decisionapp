              ...
              <Table.Row key={criterion}>
                ...
                {tools.map((tool) => {
                  ...
                  return (
                    <Table.Cell
                      key={tool}
                      className={`pugh-score-cell pugh-score-cell-editable${isWinner(tool) ? ' pugh-winner-cell' : isHighlighted(tool) ? ' pugh-highlight-cell' : ''}`}
                      style={{
                        backgroundColor: colors.bg,
                        color: colors.text,
                      }}
                      onClick={() => startEditing(tool, criterion)}
                    >
                      {editing ? (
                        <div
